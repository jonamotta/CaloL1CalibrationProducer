...
from L1Trigger.Configuration.customiseSettings import L1TSettingsToCaloParams_2022_newCalibManualSaturation_5
...
process = L1TSettingsToCaloParams_2022_newCalibManualSaturation_5(process)
