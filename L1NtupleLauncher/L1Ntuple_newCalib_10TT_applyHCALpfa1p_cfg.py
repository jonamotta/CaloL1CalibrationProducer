...
from L1Trigger.Configuration.customiseSettings import L1TSettingsToCaloParams_2022_newCalib_10TT
...
process = L1TSettingsToCaloParams_2022_newCalib_10TT(process)
