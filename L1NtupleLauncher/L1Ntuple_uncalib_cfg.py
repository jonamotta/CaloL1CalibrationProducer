...
# with command line options: l1Ntuple -s RAW2DIGI --python_filename=L1Ntuple_uncalib_cfg.py -n 300 --no_output --era=Run3 --mc --conditions=123X_mcRun3_2021_realistic_v11 --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulMCFromRAWSimCalTP --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleRAWEMUGEN_MC --customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_2022_noL1calib --filein=/store/mc/Run3Summer21DR/SinglePhoton_Pt-200to500-gun/GEN-SIM-DIGI-RAW/NoPUFEVT_120X_mcRun3_2021_realistic_v6-v2/2550000/eae83b49-986c-43e1-bb72-12208a96d928.root --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/Run3Summer21DR/SinglePhoton_Pt-200to500-gun/GEN-SIM-DIGI-RAW/NoPUFEVT_120X_mcRun3_2021_realistic_v6-v2/2550000/eae83b49-986c-43e1-bb72-12208a96d928.root'),
