...
python submitOnTier3.py --njobs 300 --applyHCALpfa1p --doNu        --applyNewCalibECALsaturAt 1.2 --applyNewCalibHCALsaturAt 1.5
...
# python submitOnTier3.py --njobs 750 --applyHCALpfa1p --doQCD       --applyOldCalib
