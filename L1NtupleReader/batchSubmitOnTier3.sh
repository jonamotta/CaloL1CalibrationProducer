...
python batchSubmitOnTier3.py --doQCDnoPU --etacut 37 --indir 2022_05_12_NtuplesV15 --applyHCALpfa1p --applyNoCalib --calibECALOnTheFly newCalib --lJetPtCut 15 --uJetPtCut 500 --trainPtVers HCAL
