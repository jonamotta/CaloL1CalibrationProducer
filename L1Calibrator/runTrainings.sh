...
sleep 5
python CalibrationFactor.py --indir 2022_06_01_NtuplesV19 --start 1 --stop 200 --maxeta 28 --v ECAL --tag _0pt500 --padZeros --saturateAt 1.75
sleep 5
python CalibrationFactor.py --indir 2022_06_01_NtuplesV19 --start 1 --stop 200 --v HCAL --tag _30pt1000 --padZeros
sleep 5
python CalibrationFactor.py --indir 2022_06_01_NtuplesV19 --start 1 --stop 200 --v HCAL --tag _30pt1000_eta41 --padZeros --saturateAt 1.75
sleep 5
